...
class GymCardThreeView extends StatefulWidget {
  static const String id = 'gym_card_three_view';
  @override
  _GymCardThreeViewState createState() => _GymCardThreeViewState();
}

class _GymCardThreeViewState extends State<GymCardThreeView> {
  ...
  Future<int> getNumUsers() {
    return _firestore.collection("Gyms").doc("Gym 3").get()
              ...
              Text(
                ...
                child: Column(
                    children: <Widget>[StreamBuilder<QuerySnapshot>(
                        stream: _firestore.collection("Gym3CheckedIn").snapshots(),
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () async {
                          ...
                          if(!user.exists && !user2.exists && !user3.exists && !user4.exists) {
                            ...
                            _firestore.collection("Gym3CheckedIn")
